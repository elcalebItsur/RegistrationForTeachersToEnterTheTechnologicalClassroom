...
export function Registro() {
  ...
  const softwareAT1_4_5 = listaSoftware["AT1_4_5"].map((materia) => ({ title: materia }));

  const onCarreraChange = (event, carreraSeleccionada) => {
    if (carreraSeleccionada && MateriasCarrera[carreraSeleccionada.id.toString()]) {
  ...
  return (
    <div className="Registro">
      ...
      <h4>Docente: Germán Guzmán Guzmán </h4>
